...
'''
# 아홉 개의 줄에 걸쳐 난쟁이들의 키가 주어짐 // 마피아 2명을 추려라!
...
# 리스트로 입력 받아줌
arr = [int(input()) for heit in range(9)]
# arr = []
# for heit in range(9) :
...
# ### 140 - 2명 = 100 /// 2명의 합이 == 40이다 32 33 35 38
# 합이 40이 안 되면 s를 뒤로 한 칸씩 보내보자
# # 합이 40을 넘으면 e를 앞으로 한 칸씩 보내보자
# # [7, 8, 10, 13, 15, 19, 20, 23, 25, 28]
# #  s 4
# #                            e 7
